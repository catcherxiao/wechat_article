...
## 更新摘要
**所做更改**
- 更新了项目概览以反映文档重构：README.md已简化为项目概览
- 新增了详细的部署指南章节，整合了原有的部署文档
- 完善了技术架构图和组件关系说明
- 增强了目标用户群体和技术选型理由的阐述
...
**更新** README.md已简化为项目概览，详细文档已整合到其他专门章节中，包括部署指南、技术架构和使用说明等。
...
2. **配置环境变量**
   ...
   export ARTICLE_JIKE_ACCESS_TOKEN=your_access_token
   ```
...
### Docker 部署（可选）
项目支持 Docker 容器化部署，可通过以下方式构建和运行：
